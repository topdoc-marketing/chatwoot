...
function setup_chatwoot() {
  ...
  git clone https://github.com/topdoc-marketing/chatwoot.git
  cd chatwoot
  git checkout "$BRANCH"
  bundle
  yarn
...
function configure_systemd_services() {
  cp /home/topdoc-marketing/chatwoot/deployment/chatwoot-web.1.service /etc/systemd/system/chatwoot-web.1.service
  cp /home/topdoc-marketing/chatwoot/deployment/chatwoot-worker.1.service /etc/systemd/system/chatwoot-worker.1.service
  cp /home/topdoc-marketing/chatwoot/deployment/chatwoot.target /etc/systemd/system/chatwoot.target

  cp /home/topdoc-marketing/chatwoot/deployment/chatwoot /etc/sudoers.d/chatwoot
  cp /home/topdoc-marketing/chatwoot/deployment/setup_20.04.sh /usr/local/bin/cwctl
...
function setup_ssl() {
  ...
  wget https://raw.githubusercontent.com/topdoc-marketing/chatwoot/develop/deployment/nginx_chatwoot.conf
...
Report bugs at https://github.com/topdoc-marketing/chatwoot/issues
